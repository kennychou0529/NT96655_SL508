...
// Wi-Fi power
#define GPIO_WIFI_POWER_PWM5        C_GPIO_15//P_GPIO_41
...
#define GPIO_RED_LED                C_GPIO_6//L_GPIO_14
#define PAD_RED_LED                PAD_PIN_CGPIO6 //PAD_PIN_LGPIO14

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_GREEN_BY_GPIO
#define GPIO_GREEN_LED             C_GPIO_14//P_GPIO_43//P_GPIO_7
#define PAD_GREEN_LED               PAD_PIN_CGPIO14//PAD_PIN_PGPIO43//PAD_PIN_PGPIO7
...
#define GPIO_FOCUS_LED              P_GPIO_7
#define PAD_FOCUS_LED               PAD_PIN_PGPIO7
#define PWMID_FOCUS_LED             PWMID_7

#define GPIO_DC_DET 	P_GPIO_54//P_GPIO_47
#define PAD_DC_DET                 PAD_PIN_PGPIO54//PAD_PIN_PGPIO47
...
//Watchdog_Timer
#define PWMID_WATCHDOG_PCTL  		P_GPIO_36
#define PAD_WATCHDOG_PCTL           PAD_PIN_PGPIO36

//#define GPIO_WATCHDOG_EN			P_GPIO_36
//#define PAD_GPIO_WATCHDOG_PCTL      PAD_PIN_PGPIO36
extern void     GPIOMap_SetWatchDogStatus(BOOL HiOrLow);

#define GPIO_ACC_DET           P_GPIO_37           // Key Shutter2 (ks2)
#define PAD_ACC_DET            PAD_PIN_PGPIO37
extern UINT32   GPIOMap_ACCDet();


extern void GPIOMap_SetWifiPower(BOOL En);
extern BOOL  GPIOMap_GetWifiPower(void);
//--------------------------------------------------------------------
// Sensor device
//--------------------------------------------------------------------
// Sensor
#define GPIO_SENSOR_RESET           S_GPIO_26//D_GPIO_7
#define GPIO_SENSOR_PWM0            P_GPIO_38//P_GPIO_50
#define GPIO_SENSOR_PWM1            P_GPIO_50//P_GPIO_51
// CCD
/*
typedef enum
{
