...
#define GPIO_RED_LED                P_GPIO_39//P_GPIO_40   //wifi led
#define PAD_RED_LED                 PAD_PIN_PGPIO39//PAD_PIN_PGPIO40

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_GREEN_BY_GPIO
#define GPIO_GREEN_LED              P_GPIO_36
#define PAD_GREEN_LED               PAD_PIN_PGPIO36
...
extern BOOL GPIOMap_AccDet(void);

#define GPIO_DC_DET 	P_GPIO_38
#define PAD_DC_DET                 PAD_PIN_PGPIO38
