...
#define UART_CONNECT_MCU      0x01
#define UART_CONNECT_CARDV      0x02

#define MCU_START1_BYTE      0x5A  // "|"
#define MCU_START2_BYTE      0xA5  // "~"

#define MCU_COMMAND_POWEROF     0X02
#define MCU_COMMAND_UPDATE_ACK     0XB0

#define UART_DATA_TYPE    UART_CONNECT_MCU
...
BOOL GPSRec_CheckPowerDown(void)
{
...
BOOL McuRec_GetMcuInfo(MCUINFO *pMcuInfo)
{
    memcpy(pMcuInfo,&MCUInfo,sizeof(MCUINFO));
    if (MCUInfo.IsUpdateMcuFW== TRUE)  //Data valid
    {
        return TRUE;
    }
    else
