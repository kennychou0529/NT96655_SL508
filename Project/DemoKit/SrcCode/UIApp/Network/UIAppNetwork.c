...
char gSSID[WSC_MAX_SSID_LEN] = "SL508";
//char gSSID[WSC_MAX_SSID_LEN] = "magic";
...
static CHAR    wifiPassward_str[26] = "12345678";
#endif
...
INT32 UINet_WifiInit(UINT32 mode,UINT32 security)
{
    ...
    else
    {
        ...
        gMacAddr[3], gMacAddr[4], gMacAddr[5]);
	#if(_MODEL_DSC_ == _MODEL_DEMO1_)
        sprintf(wifissid_str,"HZW%04d",(gMacAddr[4]<<8 |gMacAddr[5])%10000);
