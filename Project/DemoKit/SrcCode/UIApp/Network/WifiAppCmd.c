...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_HDR     ,0      ,(UINT32)XML_SetHDR,0, FL_MOVIE_HDR)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOTION_DET    ,0     ,(UINT32)XML_SetMotionDet,0, FL_MOVIE_MOTION_DET)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_LIVEVIEW_SIZE, 0, (UINT32)XML_SetLiveViewSize, 0, FL_WIFI_MOVIE_APP_PREVIEW_SIZE)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_ROTATE, NVTEVT_WIFI_EXE_ROTATE, 0, 0, FL_NULL)
