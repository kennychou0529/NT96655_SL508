...
SHOW_ITEM_GROUP(CMD_Group,Normal2,280,0,307,27)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiModuleLink_StaticICN_WiFi,0,280,0,307,27)
...
SHOW_ITEM_GROUP(CMD_Group,Normal6,0,213,319,236)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiModuleLink_StaticICN_TitleBar,0,0,213,319,236)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin11Rect,0,0,199,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin11)
SHOW_MAP_BODY(Skin11Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin11,0,0,199,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text13,0,0,199,27,STRID_NULL,0,0,0,0,2,1,1,256,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal10)
SHOW_MAP_BODY(Skin11)
SHOW_MAP_BODY(Text13)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal10,78,0,277,27)
...
CREATE_STATE_CTRL(UIMenuWndWiFiModuleLink_StatusTXT_WiFiMode,0,78,0,277,27)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin17Rect,0,0,319,27,0,0,0,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal16,0,35,319,62)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiModuleLink_StaticTXT_SSID,0,0,35,319,62)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin22Rect,0,0,319,27,0,0,0,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal21,0,65,319,92)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiModuleLink_StaticTXT_Key,0,0,65,319,92)
...
SHOW_ITEM_ELLIPSE(CMD_Ellipse,Ellipse71,0,1,17,16,16,0,0,3,0,0,0)
SHOW_MAP_BEGIN(Skin69)
SHOW_MAP_BODY(Ellipse71)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin69,0,0,17,17)

SHOW_MAP_BEGIN(UIMenuWndWiFiModeLink_Panel)
SHOW_MAP_BODY(Skin69)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndWiFiModeLink_Panel)
DECLARE_CTRL_LIST(UIMenuWndWiFiModeLink_Panel)
CREATE_CTRL(UIMenuWndWiFiModeLink_Panel,UIMenuWndWiFiModeLink_Panel,CTRL_WND,NULL,0 ,8,5,25,22)
SHOW_ITEM_RECT(CMD_Rectangle,Skin73Rect,0,0,29,29,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin73)
SHOW_MAP_BODY(Skin73Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin73,0,0,29,29)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon74, 1, 1, 11,15, ICONID_NULL,83886080,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal72)
SHOW_MAP_BODY(Skin73)
SHOW_MAP_BODY(Icon74)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal72,40,0,69,29)

SHOW_MAP_BEGIN(UIMenuWndWiFiModeLink_Static_Lock)
SHOW_MAP_BODY(Normal72)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndWiFiModeLink_Static_Lock)
CREATE_STATIC_DATA(UIMenuWndWiFiModeLink_Static_Lock,ICON_LOCK)
CREATE_STATIC_CTRL(UIMenuWndWiFiModeLink_Static_Lock,0,40,0,69,29)
