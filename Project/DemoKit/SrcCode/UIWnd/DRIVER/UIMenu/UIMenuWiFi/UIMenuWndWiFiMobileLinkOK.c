...
BOOL gbDisconnectWifiDerectly=FALSE;
...
CTRL_LIST_ITEM(UIMenuWndWiFiMobileLinkOK_Static_Lock)
CTRL_LIST_ITEM(UIMenuWndWiFiMobileLinkOK_StaticICN_WiFi)
CTRL_LIST_END
...
INT32 UIMenuWndWiFiMobileLinkOK_OnExeSensorRotate(VControl *, UINT32, UINT32 *);
...
INT32 UIMenuWndWiFiMobileLinkOK_OnMovieCutFileEnd(VControl *, UINT32, UINT32 *);
...
//EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIMenuWndWiFiMobileLinkOK_OnExeMovieRec)
...
EVENT_ITEM(NVTEVT_WIFI_EXE_ROTATE,UIMenuWndWiFiMobileLinkOK_OnExeSensorRotate)
...
EVENT_ITEM(NVTEVT_ALGMSG_PROGRESSEND,UIMenuWndWiFiMobileLinkOK_OnMovieCutFileEnd)
...
INT32 UIMenuWndWiFiMobileLinkOK_OnOpen(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    UxCtrl_SetShow(&UIMenuWndWiFiMobileLinkOK_Static_LockCtrl,FALSE);   	
...
INT32 UIMenuWndWiFiMobileLinkOK_OnExeModeChange(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    debug_msg("UIMenuWndWiFiMobileLinkOK_OnExeModeChange..\r\n");
    switch(par)
    {
...
INT32 UIMenuWndWiFiMobileLinkOK_OnExeSensorRotate(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UIMenuWndWiFiMobileLinkOKTraceMsg("%s \r\n",__FUNCTION__);
    UINT32 Data = 0;
    if(paramNum)
    ...
    Ux_SendEvent(0,NVTEVT_EXE_SENSOR_ROTATE, 1, Data);
    return NVTEVT_CONSUME;
}
...
INT32 UIMenuWndWiFiMobileLinkOK_OnMovieCutFileEnd(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    if(UxCtrl_IsShow(&UIMenuWndWiFiMobileLinkOK_Static_LockCtrl))
    {
	 UxCtrl_SetShow(&UIMenuWndWiFiMobileLinkOK_Static_LockCtrl,FALSE);
    }
    return NVTEVT_CONSUME;
...
INT32 UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyDown(VControl *, UINT32, UINT32 *);
INT32 UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyShutter2(VControl *, UINT32, UINT32 *);
INT32 UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnGsensorTrig(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_WIFIONOFF,UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyEnter)
EVENT_ITEM(NVTEVT_KEY_MODE,UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyMode)
EVENT_ITEM(NVTEVT_KEY_DOWN,UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyDown)
EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyShutter2)
//EVENT_ITEM(NVTEVT_GSENSOR_TRIG,UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnGsensorTrig)
...
INT32 UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyEnter(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	...
	for(i=0;i<20;i++)
	{
		debug_msg("delay some time for stop movie record...\r\n");
	}
...
INT32 UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyDown(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	if(UIFlowWndWiFiMovie_GetStatus()==WIFI_MOV_ST_RECORD)
        {
		if(g_bgsensor==FALSE)
...
INT32 UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnKeyShutter2(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	if(UIFlowWndWiFiMovie_GetStatus()==WIFI_MOV_ST_RECORD)
	{
	    UIFlowWndWiFiMovie_OnExeKeyShutter2(FALSE);
...
INT32 UIMenuWndWiFiMobileLinkOK_Button_Disconnect_OnGsensorTrig(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	if(UIFlowWndWiFiMovie_GetStatus()==WIFI_MOV_ST_RECORD)
        {
		if(g_bgsensor==FALSE)
...
//----------------------UIMenuWndWiFiMobileLinkOK_Static_LockCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndWiFiMobileLinkOK_Static_Lock)
EVENT_END

//----------------------UIMenuWndWiFiMobileLinkOK_StaticICN_WiFiCtrl Event---------------------------
EVENT_BEGIN(UIMenuWndWiFiMobileLinkOK_StaticICN_WiFi)
EVENT_END
