...
#define FW_VERSION_NUM                  "CARDV_20140805"
#endif
...
#undef AUTOSLEEP_FUNCTION
#define AUTOSLEEP_FUNCTION              ENABLE
#undef AUTOPWROFF_FUNCTION
...
#define _MOVIE_TINY_MODE_               ENABLE   // Movie DRAM Tiny Mode
...
#define DIRECT_WIFI_ON                  ENABLE

/*
  Time Zone range: UTC-11 ~ UTC+14
  one time zone granular is 60
*/
#define     TUTK_TIMEZONE_OFFSET        660 // 11*60
#define     TUTK_MAX_TIMEZONE_OFFSET    840 // 14*60
#define     LOCAL_TIMEZONE              480     /* China/Taiwan/HK time zone,UTC+8:00 */
